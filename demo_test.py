...
""" from chatbot import word_token """
import word_token
import jieba
import random
import pyttsx3
import os
""" from chatbot.jieba_test.pyaudio_test.txt_speech import speaker
from chatbot.jieba_test.pyaudio_test.recorad_fun import record
from chatbot.jieba_test.pyaudio_test.wav_to_txt import get_text """

from jieba_test.pyaudio_test.txt_speech import speaker
from jieba_test.pyaudio_test.recorad_fun import record
from jieba_test.pyaudio_test.wav_to_txt import get_text
...
""" max_token_id = wordToken.load_file_list(['chatbot/samples/question', 'chatbot/samples/answer'], min_freq) """
...
def predict():
    ...
    with tf.Session() as sess:
        ...
        """ sys.stdout.write("请发问") """
        engine.say('请发问')
        engine.runAndWait()
        
        """ os.system('python recorad_fun.py') """
        """ sys.stdout.write('第一次') """
        record()
        input_seq = get_text() 
        """ sys.stdout.flush()
